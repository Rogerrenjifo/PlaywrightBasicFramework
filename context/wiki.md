...
- Base URL (no hash) shows the market page.
...
### Phase 4: Default Market Entry
- Changed default route from #admin to #market
- Base URL now shows public market page directly
